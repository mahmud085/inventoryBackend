module.exports = function(SalesAgent) {
	var app = require('../../server/server');
var json2csv = require('json2csv');
var csv2 = require('csv-to-collection');
var fs = require('fs');
SalesAgent.remoteMethod(
	'exportImport',
	{
...
var result = [];
SalesAgent.exportImport = function(data,cb){
	var modelname = data.fieldname; 
	var user = data.userId;
	if(modelname === 'sales_agent'){
		app.models.sales_agent.find({where:{userId:user}},function(err,res){
